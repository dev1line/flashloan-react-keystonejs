...
import { setChartPaneState, setHistoryPaneState } from 'state/Flashloan'
...
const MobileMenu = () => {
  ...
  return (
    <StyledMobileMenu>
      <ButtonNav>
        <IconButton variant="text" onClick={() => swiper.slidePrev()} disabled={status !== Flashloantatus.LIVE}>
      ...
      <ButtonNav>
        <IconButton variant="text" onClick={() => swiper.slideNext()} disabled={status !== Flashloantatus.LIVE}>
