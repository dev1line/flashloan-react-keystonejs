...
import { CardBody, PlayCircleOutlineIcon, Button, useTooltip, ArrowUpIcon, ArrowDownIcon, Box } from '@pancakeswap/uikit'
import { useTranslation } from 'contexts/Localization'
import { useAppDispatch } from 'state'
import { BetPosition, Round } from 'state/types'

import { markPositionAsEntered } from 'state/Flashloan'
            ...
            {canEnterPosition ? (
              <>
                ...
                <Button
                  ...
                  mb="4px"
                  disabled={!canEnterPosition ||true}
                >
                  {t('Enter UP')}
                </Button>
                <Button
