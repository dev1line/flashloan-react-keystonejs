...
import { setLoan, setReverseCoin, setSwiperList } from 'state/predictions' 
import { useAppDispatch } from 'state'
import { useSelector } from 'react-redux'
import { numberOrNull } from 'state/predictions/helpers'
...
const StartLoanSetUp: React.FC<PropsStart> = ({block}) => {
  ...
  const loan = useSelector((state:State) => state.predictions.swiperList[0].loan)
